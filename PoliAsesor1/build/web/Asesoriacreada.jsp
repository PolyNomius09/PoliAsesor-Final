<%-- 
    Document   : Asesoriacreada
    Created on : 20/11/2021, 04:15:56 PM
...
<% HttpSession sesionCliente = request.getSession();
    ...
    if(usuario != null){
      ...
      List <Asesorias> idasesoria = AccionesUsuario.Obteneridase(usuario);
      int id = 0;
     
    for (Asesorias c : idasesoria) {
      id = c.getId();
    }
...
<%}%>         
     ...
     for( Asesorias  a : datos){  %>
        <div class="DescripcionAsesoria">
            ...
            <div class="horario">
                ...
                <input type="text" class="aseid" name="idase" style="visibility: hidden;" value="<%=a.getId() %>">
    ...
    <script src="JS/verAsesoria.js"></script>
