...
<body style=" background-image: url(img/aa.png);" class="container">
    ...
    <li style="float: right;margin-top: .7vw;margin-left: .4vw;"><a href="horario.jsp"
      style="padding: 0;"><img src="img/horario.png" width="40" height="40" style="display: inline-flex"
          alt="" /></a></li>
    <li style="float: right;margin-top: .7vw;margin-left: .4vw;"><a href="misasesorias.jsp"
      style="padding: 0;"><img src="img/misaseblaco.png" width="40" height="40" style="display: inline-flex"
          alt="" /></a></li>
                <%   if(rol == "1"){ %>
...
<%}%>         
    ...
    <div id="myDropdown" class="dropdown-content">
      <center><a href="perfil.html">Mi Perfil</a>
  ...
  <div class="asesorias" id="ase" style="display: block;">
    ...
    <div class="horadiv">
      ...
      <form id="form1" action="vermasmis.jsp">
        <input type="number" name="idase" value="<%=c.getId() %>" style="visibility: hidden;" >
      <table class="botonestabla">
        <tr>
          <td> <input type="submit"  value="Ver Más" class="botones2"></td>
          <td>  <input type="button" onclick="return c()" value="Editar" class="botones"></td>
        </tr>
      </table>
