...
<%}%>         
      ...
      <%  List <Asesorias> datos = AccionesUsuario.Obtenerdatosase2(id,usuario);
     ...
     for( Asesorias  a : datos){  %>
        <div class="DescripcionAsesoria">
            ...
            <div class="CupoDis">
                ...
                <table>
                    <tr>
                        <td> <input type="submit"  onclick="document.getElementById('form1').setAttribute('action','AsesorPrincipal.jsp')"  class="edicion" id="cancelar" value="Regresar"></td>

                    <td> <input type="submit" onclick="document.getElementById('form1').setAttribute('action','inscribirasesoria')" class="borrar" id="botonEdicion" value="Inscribir"></td>
                </tr>
