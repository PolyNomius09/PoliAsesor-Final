...
<html lang="en">
    ...
    <div class="DescripcionAsesoria">
        ...
        <% System.out.println("la boleta del asesor:" + a.getBoletaasesor());
            String con = AccionesUsuario.contacto(a.getBoletaasesor());
            System.out.println("contacto es" + con);
        %>
        <div style =" position: absolute;
             ...
             border-radius: 3px;
             z-index: -1;" >
            <strong style="color: #74003E;"> Contacto: </strong>
            <input type="text" required  
                   id="Contacto"  value="<%=con%>" readonly >
        </div>
        ...
        <form  method="Post" id="form1"><% System.out.println("la asesoria es la numero:" + a.getId());
            %>
            <input type="text" class="idase" name="idase" style="visibility: hidden;" value= "<%=id%>">
            <input type="text" class="idase" name="usu" style="visibility: hidden;" value= "<%=usuario%>">
            <table>
                <tr>
                    <td> <input type="submit" style="top:77%;" formaction="misasesorias.jsp"  class="edicion" id="cancelar" value="Mis Asesorias"></td>

                    <td> <input type="submit" style="top:77%;" formaction="dardebaja" class="borrar" id="botonEdicion" value="Dar de Baja"></td>
                </tr>
