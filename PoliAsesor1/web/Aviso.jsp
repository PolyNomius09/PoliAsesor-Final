...
// Close the dropdown menu if the user clicks outside of it
    ...
    <body style=" background-image: url(img/aa.png);background-repeat: no-repeat
          ;background-size: auto" class="container">



    <center>  
        <div style="margin-top: -4vw;" class="politicas">

            <embed  src="pdf/a.pdf#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" class="pdf" />

        </div>
        <div style="margin-top: 17vw;">
    ...
    <fieldset id="billing">
                ...
                <input class="boton" type="reset" onclick="history.back()" value="Regresar">
                <input class="boton" disabled id="cont" class="aa" type="submit" value="Continuar" >
                    </fieldset>
