...
<html>
    ...
    <body>
           ...
           <li style="float: right;">
            ...
            <a href="RegistrarUsuario.jsp">
                ...
                <li style="float: right;margin-top: .7vw;margin-left: .4vw;"><img src="img/misase.png" width="40" height="40" style="display: inline-flex" alt=""/></li>
                 ...
                 <a href="usuariosinactivos.jsp">    
                <li style="float: right;margin-top: .7vw;margin-left: .4vw;"><img src="img/usuinselec.png" width="40" height="40" style="display: inline-flex" alt=""/></li>
            </a>
        ...
        <% 
            List<MUsuario> lista = AccionesUsuario.ConsultarUsuariosin(privilegio);
        ...
        <tr>
            ...
            <td style=" padding-left: 7px">
                <a href="activarUsuario?bol_usu=<%=e.getBol_usu()%>" 
                              style="color: white;
        ...
        <center><h2 style="color: #74003E">No hay mas Usuarios Inactivos</h2></center>
        </div>
