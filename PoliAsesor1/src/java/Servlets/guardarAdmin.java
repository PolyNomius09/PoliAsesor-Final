 ...
 */
public class guardarAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String passgenrada = "CECYT"+id_uni_aca+"ADM";
...
//            
            ...
            if(estatus > 0){
                ...
                response.sendRedirect("AdminCreado.jsp");
            }else{
                response.sendRedirect("usuarioexistenteadmin.jsp");
            }
