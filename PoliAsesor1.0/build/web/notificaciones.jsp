...
<body style=" background-repeat: no-repeat; background-position: center; background-image:url(img/errorsa.png), url(img/errorpag.png)";background-size: auto;  ">
    <ul>
        ...
        <li style="float: right;margin-top: .7vw;margin-left: .4vw;"><a href="notificaciones.jsp"
                style="padding: 0;"><img src="img/notiselec.png" width="40" height="40" style="display: inline-flex"
                    alt="" /></a></li>
